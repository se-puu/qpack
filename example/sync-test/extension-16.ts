...
import { Array5, Array8, Binary8, Uint6, Uint8, Uint16, Uint24, Uint32, Uint40, Uint48, Nint5, Int8, Int16, Int24, Int32, Int40, Int48, Object5, Object8, String5, String8 } from "../../src/lib/size-enum";
import { randomBuf, randomLightArray, randomLightObject, randomNegativeIntBetween, randomPositiveIntBetween, toString } from "../lib";


export class TestExt16_1 {
    static readonly extCode = 1305;
    arr5Min = [];
    ...
    time = Date.now();
    static encode(encoder: QEncoder, data: TestExt16_1): void {
    ...
    static decode(decoder: QDecoder): TestExt16_1 {
        const retObj = new TestExt16_1();
